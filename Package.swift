...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/gokberkince/MPVKit/releases/download/0.41.0-lumen.3/Libmpv.xcframework.zip",
            checksum: "2325262c6185c2b32b5cad6af2f5fc131acf90f8047a081052c0a247113d4fe6"
        ),
