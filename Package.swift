...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/gokberkince/MPVKit/releases/download/0.41.0-lumen.1/Libmpv.xcframework.zip",
            checksum: "6027cb336ae54deddba02fd71db138dbf0d3ae8c700cade1cde8bd086fba12dd"
        ),
