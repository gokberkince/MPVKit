...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/gokberkince/MPVKit/releases/download/0.41.0-lumen.4/Libmpv.xcframework.zip",
            checksum: "9b1366c9c65e9860b651a7aac0aabf33fce5381bf6b718bee9ee57b35233f294"
        ),
